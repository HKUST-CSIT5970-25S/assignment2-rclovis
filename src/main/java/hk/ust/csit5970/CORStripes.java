...
public class CORStripes extends Configured implements Tool {
     ...
     */
    public static class CORStripesMapper2
        ...
        protected void map(LongWritable key, Text value, Context context)
             ...
             * TODO: Your implementation goes here.
             */
            String[] array = sorted_word_set.toArray(new String[0]);
            ...
            for (int i = 0; i < array.length; i++) {
                ...
                for (int j = i + 1; j < array.length; j++) {
                    ...
                    if (
                        !word.equals(word2) && map.get(new Text(word2)) == null
                    ) {
     ...
     */
    public static class CORStripesCombiner2
     ...
     */
    public static class CORStripesReducer2
        ...
        protected void reduce(
            ...
            for (Map.Entry<Writable, Writable> entry : result.entrySet()) {
                ...
                int A = word_total_map.get(key.toString());
                int B = word_total_map.get(entry.getKey().toString());
                double freq =
                    (double) ((IntWritable) entry.getValue()).get() /
                    (double) (A * B);
                context.write(
                    new PairOfStrings(
                        key.toString(),
